...
IntegerOps::string_to_Integer( "2", 16,
as_Integer( x )
);
...
IntegerOps::string_to_Integer( "1", 16,
as_Integer( x )
);
...
IntegerOps::string_to_Integer( "100000000", 16,
as_Integer( x )
);
...
IntegerOps::string_to_Integer( "-12345678ffffffff", 16,
as_Integer( x )
);
