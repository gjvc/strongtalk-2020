...
TEST( SystemPrimitivesTests, nurseryFreeSpaceShouldReturnEdenFreeSpaceAsSMI ) { ASSERT_EQ( Universe::new_gen.eden()->free(), SMIOop( SystemPrimitives::nurseryFreeSpace() )->value() ); }
