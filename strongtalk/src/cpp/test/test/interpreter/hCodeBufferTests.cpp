...
TEST_F( HCodeBufferTests, pushingByteShouldAddByteToBytesArray ) {
    ...
    code->pushByte( static_cast<uint8_t>(ByteCodes::Code::push_literal) );
    code->pushOop( messageClass );
    checkByteLength( 8, "Message" );
    checkOopLength( 2, "Message" );
    code->pushByte( static_cast<uint8_t>(ByteCodes::Code::push_self) );
    ...
    code->pushByte( static_cast<uint8_t>(ByteCodes::Code::interpreted_send_n) );
    code->pushByte( 2 );
    code->pushOop( selector );
    code->pushOop( smiOopFromValue( 0 ) );
    checkByteLength( 36, "constructor" );
    checkOopLength( 9, "constructor" );
    code->pushByte( static_cast<uint8_t>(ByteCodes::Code::interpreted_send_self) );
    code->pushOop( dnuSelector );
    code->pushOop( smiOopFromValue( 0 ) );
    checkByteLength( 48, "DNU" );
    checkOopLength( 12, "DNU" );
    code->pushByte( static_cast<uint8_t>(ByteCodes::Code::return_tos_pop_0) );
