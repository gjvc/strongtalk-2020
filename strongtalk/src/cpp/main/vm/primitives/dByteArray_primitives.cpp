...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::allocateSize( Oop
receiver,
Oop argument
) {
...
< 0 )
return
markSymbol ( vmSymbols::negative_size() );
...
// header
MemOop( obj )
->initialize_header( true, k );

// instance variables
MemOop( obj )
->
initialize_body( MemOopDescriptor::header_size(), ni_size
);
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::allocateSize2( Oop
receiver,
Oop argument, Oop
tenured ) {
PROLOGUE_2( "allocateSize", receiver, argument )
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::size( Oop
receiver ) {
...
// do the operation
return
smiOopFromValue( DoubleByteArrayOop( receiver )
->
length()
);
}
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::at( Oop
receiver,
Oop index
) {
...
// check index value
if ( not
DoubleByteArrayOop( receiver )
->
is_within_bounds( SMIOop( index )
->
value()
) )
return
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::atPut( Oop
receiver,
Oop index, Oop
value ) {
...
DoubleByteArrayOop( receiver )
->
doubleByte_at_put( SMIOop( index )
->
value(), v
);
return
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::compare( Oop
receiver,
Oop argument
) {
...
smiOopFromValue( DoubleByteArrayOop( receiver )
->
compare( DoubleByteArrayOop( argument )
) );

if ( argument->
is_byteArray()
)
return smiOopFromValue( -
ByteArrayOop( argument )
->
compare_doubleBytes( DoubleByteArrayOop( receiver )
) );
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::intern( Oop
receiver ) {
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::characterAt( Oop
receiver,
Oop index
) {
...
return Universe::asciiCharacters()->
obj_at( byte
+ 1 );
} else
return
...
Oop __CALLING_CONVENTION
doubleByteArrayPrimitives::hash( Oop
receiver ) {
PROLOGUE_1( "intern", receiver );
ASSERT_RECEIVER;
return
