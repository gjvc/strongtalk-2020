...
extern "C" doFn dispatch_table[static_cast<int>(ByteCodes::Code::NUMBER_OF_CODES )];
extern "C" doFn original_table[static_cast<int>(ByteCodes::Code::NUMBER_OF_CODES )];

doFn dispatch_table[static_cast<int>(ByteCodes::Code::NUMBER_OF_CODES )];
doFn original_table[static_cast<int>(ByteCodes::Code::NUMBER_OF_CODES )];
