...
constexpr std::int32_t INITIAL_ARG_SIZE          = 5;
constexpr std::int32_t INITIAL_TEMP_SIZE         = 5;
constexpr std::int32_t INITIAL_CONTEXT_TEMP_SIZE = 5;
...
void ScopeDescriptorNode::generateBody( ScopeDescriptorRecorder *rec, std::int32_t senderScopeOffset ) {
    if ( has_nameDescs() ) {
...
ScopeInfo ScopeDescriptorNode::find_scope( std::int32_t scope_id ) {
