...
public:
    ...
    BlockScopeNode( MethodOop method, ScopeInfo parent, bool_t allocates_compiled_context, bool_t lite, std::size_t scopeID, std::size_t senderByteCodeIndex, bool_t visible ) :
