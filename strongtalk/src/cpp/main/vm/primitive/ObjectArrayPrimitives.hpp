...
class ObjectArrayPrimitives : AllStatic {
private:
...
public:
    ...
    //              flags = #(Allocate)
    //              name  = 'ObjectArrayPrimitives::allocateSize2' }
    //%
    ...
    //   Internal { error = #(NegativeSize)
    //              flags = #(Allocate)
    //              name  = 'ObjectArrayPrimitives::allocateSize' }
    //%
    ...
    //              name  = 'ObjectArrayPrimitives::size' }
    //%
    ...
    //   Internal { error = #(OutOfBounds)
    //              flags = #(Function IndexedObject)
    //              name  = 'ObjectArrayPrimitives::atPut' }
    //%
    ...
    //              name  = 'ObjectArrayPrimitives::at_all_put' }
    //%
    ...
    //   Internal { error = #(OutOfBounds)
    //              flags = #(IndexedObject)
    //              name  = 'ObjectArrayPrimitives::replace_from_to' }
    //%
    ...
    //              flags = #(IndexedObject)
    //              name  = 'ObjectArrayPrimitives::copy_size' }
    //%
